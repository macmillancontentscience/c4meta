...
vignette: >
  %\VignetteIndexEntry{Gathering the Data}
...
Note also that the processing described here took multiple days to complete on a maching with 64GB of RAM and an Intel Core i7 processor.
...
We haved to further process nonalpha to make them fit in RAM for summarizing.
